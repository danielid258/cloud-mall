...
public class OrderServiceImpl implements OrderService {
    ...
    public OrderDTO create(OrderDTO orderDTO) {
        ...
        List<CommonProduct> productInfoList = productApi.listForOrder(productIds);
        ...
        //扣库存(调用商品服务)
        List<ProductStockGeneric> productStockList = orderDTO.getOrderDetailList().stream()
                .map(e -> new ProductStockGeneric(e.getProductId(), e.getProductQuantity()))
                .collect(Collectors.toList());
        productApi.decreaseStock(productStockList);
